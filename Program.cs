...
public static void Main()
{
 ...
 do
 { 
  Console.WriteLine("Informe a quantidade de dezenas (entre 6 e 15): ");
 ...
 Console.WriteLine(quantidadedeJogos + " Jogos de " + quantidadeDeDezenas + "dezenas: ");
 for (int j = 0; j< quantidadedeJogos; j++)
 {
